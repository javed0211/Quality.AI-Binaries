...
|---------|------|---------|-------|
| **0.1.19** | [0.1.19/Local.zip](0.1.19/Local.zip) | Bundled local MongoDB — **latest** | **x64** — shortcut/install path fix |
| 0.1.18 | [0.1.18/Local.zip](0.1.18/Local.zip) | Bundled local MongoDB | x64 — broken shortcuts on upgrade; use 0.1.19+ |
...
Install location: `%LOCALAPPDATA%\Programs\Quality.AI\QualityAI.exe` (shortcut name: **Quality.AI**)

Built from [test-agent-nexus](https://github.com/javed0211/test-agent-nexus) at commit `e2d9658d` (v0.1.19).
