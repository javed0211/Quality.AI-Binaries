...
| Version | File | Notes |
|---------|------|-------|
| **0.1.21** | [0.1.21/Local-Portable.zip](0.1.21/Local-Portable.zip) | **Use this on x64 PCs** — extract all files, run `QualityAI.exe` |
...
|---------|------|---------|-------|
| 0.1.21 | [0.1.21/Local.zip](0.1.21/Local.zip) | Bundled local MongoDB | x64 — may fail on some PCs; prefer Local-Portable |
...
Built from [test-agent-nexus](https://github.com/javed0211/test-agent-nexus) at commit `da3b143c` (v0.1.21).
